...
inv_lot_details <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Inventory Lot Detail - FG 10.12.22.xlsx")
...
custord <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/MSTR custord - 10.12.22.xlsx")
...
exception_report <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/exception report 10.12.22.xlsx")
...
fcst <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/DSX Forecast Backup - 2022.10.12.xlsx")
...
writexl::write_xlsx(final_analysis_result, "10.12.2022_risk.xlsx")
