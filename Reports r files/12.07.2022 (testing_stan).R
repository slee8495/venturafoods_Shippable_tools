...
inv_lot_details <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Inventory Lot Detail - FG 12.07.22.xlsx")
...
custord <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/MSTR custord - 12.07.22.xlsx")
...
planner_address <- read_excel("S:/Supply Chain Projects/Linda Liang/reference files/Address Book - 12.07.22.xlsx")
planner_address %>% 
  janitor::clean_names() %>% 
  readr::type_convert() %>% 
  dplyr::select(1:2) %>% 
...
exception_report <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/exception report 12.07.22.xlsx")
...
mfg <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Inventory Report for all locations - 12.07.22.xlsx")
...
fcst <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/DSX Forecast Backup - 2022.12.06.xlsx")
...
writexl::write_xlsx(final_analysis_result, "12.07.2022_risk.xlsx")
